...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "glass-button shadow-lg hover:shadow-xl",
        destructive:
          "bg-destructive text-destructive-foreground shadow-lg hover:bg-destructive/90 hover:shadow-xl hover:-translate-y-0.5",
        outline:
          "glass-input border-border/30 hover:bg-secondary/20 hover:border-border/50 hover:-translate-y-0.5",
        secondary:
          "bg-secondary/30 text-secondary-foreground shadow-lg backdrop-blur-sm hover:bg-secondary/40 hover:shadow-xl hover:-translate-y-0.5",
        ghost: "hover:bg-secondary/20 hover:text-foreground backdrop-blur-sm",
        link: "text-primary underline-offset-4 hover:underline",
        glass: "glass-button shadow-lg hover:shadow-xl",
      },
      size: {
